...
var antioxidantPage = function() {
    ...
    App.AntioxidantView = new App.Views.AntioxidantView({
        collection: App.antioxidants
    });
...
var moisturizerPage = function() {
    ...
    App.MoisturizerView = new App.Views.MoisturizerView({
        collection: App.moisturizer
    });
...
var cleanserPage = function() {
    ...
    App.CleanserView = new App.Views.CleanserView({
        collection: App.cleanser
    });
